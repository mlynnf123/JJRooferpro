-- Simplified seed data - avoiding precision issues
...
-- Insert sample lead source performance data (with safe values)
...
('11111111-1111-1111-1111-111111111113', '44444444-4444-4444-4444-444444444003', '2024-11-01', 12, 12, 10, 7, 145000.00, 0.00, 58.33, 999.99),
('11111111-1111-1111-1111-111111111114', '44444444-4444-4444-4444-444444444004', '2024-11-01', 8, 7, 4, 2, 35000.00, 37.50, 25.00, 166.67);

-- Update existing leads to reference marketing sources
UPDATE leads SET notes = CONCAT(COALESCE(notes, ''), ' | Source: Google Ads Campaign') WHERE id = '11111111-1111-1111-1111-111111111002';
UPDATE leads SET notes = CONCAT(COALESCE(notes, ''), ' | Source: Facebook Ad') WHERE id = '11111111-1111-1111-1111-111111111003';
UPDATE leads SET notes = CONCAT(COALESCE(notes, ''), ' | Source: Customer Referral') WHERE id = '11111111-1111-1111-1111-111111111001';